...
export default function DashboardPage() {
  ...
  const [topUpMethod, setTopUpMethod] = useState("crypto")
  ...
  const handleTopUp = () => {
    // Mock top-up process
    console.log(`Top up $${topUpAmount} via ${topUpMethod}`)
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="text-center">
                    <h3 className="font-bold text-lg">Panda Bear</h3>
                    <p className="text-gray-600">panda@bamboo.com</p>
                    <Badge className="mt-2 bg-green-100 text-green-800">Zen Master</Badge>
                  </div>
                </div>
              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    { title: "Wallet Balance", value: "$162", icon: Wallet, color: "purple" },
                    { title: "Zen Points", value: "2,450", icon: Star, color: "yellow" },
                  ].map((stat) => {
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {recentOrders.map((order) => (
                        <div key={order.id} className="flex items-center justify-between p-4 bg-green-50/50 rounded-lg">
                          <div className="flex items-center space-x-4">
                      ...
                      <div className="space-y-4 py-4">
                        ...
                        <div className="flex space-x-2 pt-4">
                          <Button
                            ...
                            className="flex-1 bg-white/80 border-green-200 shadow-lg"
                          >
                            Cancel
                          </Button>
                          <Button
                            onClick={handleTopUp}
                            disabled={!topUpAmount || Number.parseFloat(topUpAmount) <= 0}
                  ...
                  <Card className="bg-white/80 border-green-200 shadow-lg">
                    ...
                    <CardContent className="space-y-4">
                      <div className="text-center p-6 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg border border-green-200">
                        <div className="text-4xl font-extrabold text-green-600 mb-2">$162.04</div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-green-50/50 rounded-lg">
                          ...
                          <span className="text-green-600 font-bold">$275.00</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-green-50/50 rounded-lg">
                          <span className="font-medium">Total Spent</span>
                          <span className="text-red-600 font-bold">$112.96</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-green-50/50 rounded-lg">
                          <span className="font-medium">Pending Transactions</span>
                          <span className="text-yellow-600 font-bold">$0.00</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <TabsContent value="points" className="space-y-6">
                  ...
                  <Card className="bg-white/80 border-green-200 shadow-lg">
                    ...
                    <CardContent className="space-y-4">
                      <div className="text-center p-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                        <div className="text-4xl font-extrabold text-yellow-600 mb-2">2,450</div>
                        <p className="text-gray-600">Available Points</p>
                        <p className="text-sm text-gray-500 mt-2">Worth $24.50 in rewards</p>
                      </div>
                ...
                <Card className="bg-white/80 border-green-200 shadow-lg">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {[
                        { date: "2024-01-24", description: "Purchase - Order #ORD-001", points: "+77", type: "earned" },
                        {
                          date: "2024-01-20",
                        ...
                        { date: "2024-01-15", description: "Purchase - Order #ORD-002", points: "+36", type: "earned" },
                        {
                          date: "2024-01-10",
