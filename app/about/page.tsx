      ...
      <main className="pt-20">
        ...
        <section className="relative bg-green-700 text-white py-20 lg:py-32">
          ...
          <div className="container mx-auto px-4 relative text-center">
            <h1 className="text-5xl lg:text-7xl font-bold">About Panda Cannabis</h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                  At Panda Cannabis, our mission is simple: to provide safe, high-quality, and accessible cannabis products
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
                <Image src="/placeholder-ff1cq.png" alt="Panda Cannabis team working" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
